...
class EsState implements State {
    private static final Logger LOG = LoggerFactory.getLogger(com.ikongjian.storm_es.trident.EsState.class);
    ...
    public void prepare() {
        try {
            synchronized (com.ikongjian.storm_es.trident.EsState.class) {
                if (client == null) {
